    ...
    public function map($data): array
    {
        ...
        if ($this->dividion_id == '1') {
            return [
                ...
                isset($data['orders']['buyers']['shop_name']) ? $data['orders']['buyers']['shop_name'] : '',
                isset($data['orders']['sellers']['legal_name']) ? $data['orders']['sellers']['legal_name'] : '',
                isset($data['orders']['sellers']['distributor_code']) ? $data['orders']['sellers']['distributor_code'] : '',
