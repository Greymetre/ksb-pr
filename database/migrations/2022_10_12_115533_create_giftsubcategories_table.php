...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('giftsubcategories', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('category_id')->references('id')->on('gift_categories');
        });
    }
    ...
    {
        Schema::dropIfExists('giftsubcategories');
    }
};
