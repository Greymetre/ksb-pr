    ...
    <div class="card">
      <div class="card-header card-header-icon card-header-theme">
        ...
        <h4 class="card-title ">{!! trans('panel.country.title_singular') !!}{!! trans('panel.global.list') !!}
              @include('components.address-master-actions', [
                'module' => 'country',
                'title' => trans('panel.country.title'),
                'titleSingular' => trans('panel.country.title_singular'),
                'uploadUrl' => URL::to('country-upload'),
                'downloadUrl' => URL::to('country-download'),
                'templateUrl' => URL::to('country-template'),
                'createTarget' => '#createcountry',
                'uploadPermission' => 'country_upload',
                'downloadPermission' => 'country_download',
                'templatePermission' => 'country_template',
      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table id="getcountry" class="table table-striped- table-bordered table-hover table-checkable responsive no-wrap">
...
<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="createcountry" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content card">
      <div class="card-header card-header-icon card-header-theme">
        ...
        <h4 class="card-title"><span class="modal-title">{!! trans('panel.global.add') !!}</span> {!! trans('panel.country.title_singular') !!}
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('#getcountry').DataTable({
        processing: true,
        serverSide: true,
        "order": [ [0, 'desc'] ],
    ...
    $('.create').click(function () {
        ...
        $("#country_image").attr({ "src": '{!! asset('assets/img/placeholder.jpg') !!}' });
