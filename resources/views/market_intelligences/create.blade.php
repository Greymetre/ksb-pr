...
<x-app-layout>
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        {!! Form::model($fields,[
        'route' => $fields->exists ? ['market_intelligences.update', $fields->id] : 'market_intelligences.store',
          ...
          <div class="row">
              ...
              <div class="input_section">
                ...
                <div class="form-group has-default bmd-form-group">
                  ...
                  <div class="error col-lg-12">
                    <p class="text-danger">{{ $errors->first('label_name') }}</p>
                  </div>
                  @endif
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="input_section">
                ...
                <div class="form-group has-default bmd-form-group">
                  ...
                  <div class="error col-lg-12">
                    <p class="text-danger">{{ $errors->first('placeholder') }}</p>
                  </div>
                  @endif
                </div>
            ...
            <div class="col-md-6">
              <div class="input_section">
                ...
                <div class="form-group has-default bmd-form-group">
                  ...
                  <div class="error col-lg-12">
                    <p class="text-danger">{{ $errors->first('field_type') }}</p>
                  </div>
                  @endif
                </div>
              </div>
            ...
            <div class="col-md-6 InputType">
              <div class="input_section">
                ...
                <div class="form-group has-default bmd-form-group">
                  <select class="form-control select2" name="input_type" id="input_type" style="width: 100%;" required>
                    <option value="" selected disabled>Select Input Type</option>

                    <option value="text" {{ old( 'input_type' , (!empty($fields->input_type))?($fields->input_type):('') ) == 'text' ? 'selected' : '' }}>Text</option>
                    <option value="number" {{ old( 'input_type' , (!empty($fields->input_type))?($fields->input_type):('') ) == 'number' ? 'selected' : '' }}>Number</option>
            ...
            <div class="col-md-6 multipleshow d-none">
              <div class="input_section">
