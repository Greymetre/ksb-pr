<x-app-layout>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('new-invoices.update', $newInvoice->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <select id="secondary_customer_id" name="secondary_customer_id" 
                                ...
                                <option value="{{ $customer->id }}" 
                                    {{ $newInvoice->secondary_customer_id == $customer->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="invoice_number" id="invoice_number" 
                                        ...
                                        value="{{ old('invoice_number', $newInvoice->invoice_number) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="invoice_date" id="invoice_date" 
                                        ...
                                        value="{{ old('invoice_date', $newInvoice->invoice_date ? $newInvoice->invoice_date->format('Y-m-d') : date('Y-m-d')) }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="amount" id="amount" 
                                            ...
                                            value="{{ old('amount', $newInvoice->amount) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="points" id="points"
                                        ...
                                        value="{{ old('points', $newInvoice->points ?? 0) }}"
                                        step="0.01" min="0">
                                    @error('points')
                                    <small class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                        ...
                        @if($newInvoice->getMedia('attachments')->isNotEmpty())
                        <div class="form-group">
                            <label class="col-form-label"><strong>Current Attachments</strong></label>
                            <div class="row">
                                @foreach($newInvoice->getMedia('attachments') as $media)
                        ...
                        <div class="form-group">
                            <label class="col-form-label">
                                <strong>Add New Attachments</strong>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary">
                                    <i class="material-icons">check</i> Update Invoice
                                </button>
    ...
    $(document).ready(function() {
        ...
        // Load customer details on page load and when selection changes
        function loadCustomerDetails() {
            const customerId = $('#secondary_customer_id').val();
