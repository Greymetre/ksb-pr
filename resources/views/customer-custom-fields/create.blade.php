...
<div class="row">
   <div class="col-md-12">
      <div class="card">
          {!! Form::model($fields,[
            'route' => $fields->exists ? ['customer-custom-fields.update', $fields->id] : 'customer-custom-fields.store',
        ...
        <div class="card-header card-header-icon card-header-theme">
          ...
          <h4 class="card-title ">{!! trans('panel.global.add') !!} Custom Field
            </h4>
          </div>
         ...
         <div class="card-body">
            ...
            <!-- Table row -->
               <div class="row fielddata" @if($fields->exists && $fields['values']->count() >= 1 ) '' @else style="display: none;" @endif>
                  <div class="container-fluid mt-5 d-flex justify-content-center w-100">
                     <div class="table-responsive w-100">
                        <table class="table kvcodes-dynamic-rows-example" id="tab_logic">
                           ...
                           <tbody >
                              @if($fields->exists && isset($fields['values']))
                              @foreach($fields['values'] as $index => $rows )
                              <tr id='addr0'>
