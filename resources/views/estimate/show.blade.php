  ...
  <section class="invocie_main">
    <div class="container-fluid">
      <div class="controls">
        ...
        <a href="{{ route('tax_invoice.show', ['tax_invoice' => $estimate->invoice_id]) }}" class="btn btn-success">Converted</a>
        @else
        <a href="{{ route('convert_to_tax_invoice', ['convert_estimate' => $estimate->id]) }}" id="convert" class="btn" title="Convert to PDF"> Convert</a>
        @endif
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="4">
                ...
                <table style="width: 100%; border:0px;" border="0">
                  ...
                  @endforeach
                  @endif
                  @if($estimate->tds_amount != 0)
                  <tr>
                    <td style="border:0px;padding: 0px 8px; text-align:right;color: #000;font-weight: 400; line-height: 20px;">Amount Withheld</td>
                    <td style="border:0px;padding: 0px 8px; text-align:right;color: #000;font-weight: 400;line-height: 20px;color:red;">{{number_format($estimate->tds_amount, 2)}}</td>
                  </tr>
                  @endif
                  ...
                  <tr>
                    ...
                    <td style="border:0px;padding: 0px 8px; text-align:right;color: #000;font-weight: 400;line-height: 20px;">{{number_format($estimate->adjustment, 2)}}</td>
                  </tr>
                  @endif
                  <tr>
            ...
            <tr>
              <td rowspan="2" colspan="3" style="border:0px!important;">
                ...
                <p style="color:#000; font-weight: 400;">Terms and Conditions</p>
                <p style="color:#000; font-weight: 400; margin-bottom: 0px; line-height: 16px;">{!! nl2br(e($estimate->t_c)) !!}</p><br>
              </td>
              @if($estimate->place_of_supply == ($settings->address ? $settings->address->state_id : 1))
