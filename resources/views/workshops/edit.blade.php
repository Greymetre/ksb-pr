    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::model($customer, [
                    'route' => ['workshops.update', $customer],
                    'method' => 'PUT',
                    'files' => true,
                    'id' => 'workshopEditForm'
                ]) !!}
                ...
                <div class="col-md-6">
    <label>Distributor Name <span class="text-danger">*</span></label>
   {!! Form::select('distributor_name', $distributorOptions ?? ['' => 'Select Distributor'], 
    old('distributor_name', $customer->distributor_name), [
    'class' => 'form-control select2',
    'required'
]) !!}
</div>
                ...
                <!-- Workshop specific extra fields (same as Retailer) -->
        ...
        {!! Form::text('gps_location', old('gps_location', $customer->gps_location ?? null), [
            ...
            'placeholder' => 'e.g., 17.385044,78.486671'
                ...
                <div class="card-footer text-right mt-5">
                    <button type="submit" class="btn btn-theme">Update Workshop</button>
