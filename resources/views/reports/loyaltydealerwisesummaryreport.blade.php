  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header card-header-icon card-header-theme">
        ...
        <h4 class="card-title">Loyalty Summary Dealer Wise Report
          <span class="">
            <div class="btn-group header-frm-btn">
              @if(auth()->user()->can(['customer_download']))
              <form method="GET" action="{{ URL::to('loyalty-delaer-wise-report-download') }}">
                  ...
                  <div class="p-2"><button class="btn btn-just-icon btn-theme" title="{!!  trans('panel.global.download') !!} Loyalty Summary Dealer Wise Report"><i class="material-icons">cloud_download</i></button></div>
                  @endif
              </form>
              @endif
            </div>
