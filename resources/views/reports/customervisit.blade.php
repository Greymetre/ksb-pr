    <x-app-layout>
        ...
        let districtMapping = @json(\App\Models\District::pluck('district_name', 'id'));
        let pincodeMapping = @json(\App\Models\Pincode::pluck('pincode', 'id'));
        </script>
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            return districtMapping[data] || data || '-';
                        }
                    },
                    {
                        data: 'city_name',
                    ...
                    },
                    {
                        ...
                        name: 'pincode',
                        render: function(data) {
                            return pincodeMapping[data] || data || '-';
                        }
                    },
                    {
                        data: 'address',
