  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header card-header-icon card-header-theme">
        ...
        <h4 class="card-title">{!! trans('panel.distributors.title') !!}{!! trans('panel.global.list') !!}
          <span class="pull-right">
            <div class="btn-group">
              @if(auth()->user()->can(['customer_download']))
              <a href="{{ URL::to('distributor-download') }}" class="btn btn-just-icon btn-theme" title="Distributor Download"><i class="material-icons">cloud_download</i></a>
              @endif
              @if(auth()->user()->can(['distributor_create']))
              <a href="{{ url('distributors/create') }}" class="btn btn-just-icon btn-theme" title="{!! trans('panel.distributors.title') !!}{!! trans('panel.global.list') !!}"><i class="material-icons">add_circle</i></a>
              @endif
            </div>
          </span>
        </h4>
      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
            ...
            <thead class=" text-primary">
              ...
              <th>Firm Name</th>
              <th>{!! trans('panel.distributors.fields.first_name') !!}</th>
              <th>{!! trans('panel.distributors.fields.last_name') !!}</th>
              <th>{!! trans('panel.distributors.fields.mobile') !!}</th>
              <th>{!! trans('panel.distributors.fields.profile_image') !!}</th>
              <th>{!! trans('panel.distributors.fields.customertype') !!}</th>
...
<script type="text/javascript">
  $(function () {
    ...
    $('body').on('click', '.distributorActive', function () {
        var id = $(this).attr("id");
