                     ...
                     <div class="form-group bmd-form-group">
                        <select class="form-control select2" name="task_department_id" id="task_department_id" required style="width: 100%;">
                           ...
                           @foreach($departments as $department)
                              <option value="{{ $department->id }}" {{ old('task_department_id', $tasks['task_department_id'] ?? '') == $department->id ? 'selected' : '' }}>
                                 {{ $department->name }}
                              </option>
                           @endforeach
                     ...
                     <div class="form-group bmd-form-group">
                        <select class="form-control select2" name="task_priority_id" id="task_priority_id" required style="width: 100%;">
                           ...
                           @foreach($priorities as $priority)
                              <option value="{{ $priority->id }}" {{ old('task_priority_id', $tasks['task_priority_id'] ?? '') == $priority->id ? 'selected' : '' }}>
                                 {{ $priority->name }}
                              </option>
                           @endforeach
