      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
            ...
            <thead class=" text-primary">
              ...
              <th>{!! trans('panel.scheme.fields.scheme_image') !!}</th>
  ...
  $(function () {
    ...
    var table = $('#getscheme').DataTable({
        ...
        columns: [
            ...
            {data: 'scheme_name', name: 'scheme_name',"defaultContent": ''},
            {data: 'scheme_description', name: 'scheme_description',"defaultContent": ''},
