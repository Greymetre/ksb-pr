<x-app-layout>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {!! Form::model($customer, [
                    'route' => ['retailers.update', $customer],
                    'method' => 'PUT',
                    'files' => true,
                    'id' => 'retailerEditForm'
                    ]) !!}
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            ...
                            <div id="mobile_numbers_wrapper" class="row">
                                ...
                                @php
                                $mobiles = isset($customer->mobile_number) ? explode(',', $customer->mobile_number) :
                                [''];
                                @endphp
                                ...
                                <div class="mobile-row col-md-6 mb-2">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="mobile_numbers[]" class="form-control mr-2"
                                            value="{{ $mobile }}" placeholder="Mobile Number {{ $index+1 }}"
                                            maxlength="10" pattern="[6-9]{1}[0-9]{9}" required>
    ...
    'multiple' => true
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="password" name="bank_account_number" id="bank_account_number"
                                class="form-control" placeholder="Enter New Bank Account Number"
                        ...
                        <div class="col-md-6">
                            <label>
                                ...
                                <small id="confirm-label" class="text-muted">(optional)</small>
                            </label>
                    ...
                    <!-- Retailer specific extra fields -->
                    <!-- <div class="row mt-4">
                    <div class="col-md-6">
                        <label>Distributor Name <span class="text-danger">*</span></label>
        ...
        {!! Form::select('beat_id', ['' => 'Select Beat'] + $beats->toArray(), 
            ...
            'required'
                    ...
                    <div class="card-footer text-right mt-5">
                        <button type="submit" class="btn btn-theme">Update Retailer</button>
    ...
    `;
        ...
        $('#retailerEditForm').on('submit', function(e) {
            ...
            // NEW LOGIC
            if (!acct) {
                $('#bank_account_number').removeAttr('name');
                $('#bank_account_number_confirm').removeAttr('name');
                return true;
            }

            // Account filled but confirm empty
            if (acct && !confirm) {
