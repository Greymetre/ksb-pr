<x-app-layout>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-icon card-header-theme">
                    ...
                    <h4 class="card-title">
                        ...
                        <span class="pull-right">
                            <a href="{{ route('retailers.index') }}" class="btn btn-theme">
                ...
                <div class="card-body">
                    ...
                    <h5 class="mt-3 mb-4 text-theme font-weight-bold">Retailer Photos</h5>
                    <div class="row mb-5">
                                ...
                                <div class="card-body p-3">
                                    @if($customer->owner_photo)
                                        <img src="{{ asset('storage/'.$customer->owner_photo) }}"
                                             class="img-fluid rounded shadow-sm retailer-image-popup cursor-pointer"
                            ...
                            <div class="card shadow-sm border-0 h-100">
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <img src="{{ asset('storage/'.$customer->shop_photo) }}"
                                        class="img-fluid rounded shadow-sm retailer-image-popup cursor-pointer"
                                        style="max-height: 250px; object-fit: cover;" alt="Shop Photo">
                                    @else
                                    <img src="{{ asset('assets/img/placeholder.jpg') }}"
                                        class="img-fluid rounded shadow-sm"
                                        style="max-height: 250px; object-fit: cover;" alt="No Shop Photo">
                                    <p class="text-muted mt-3 mb-0"><em>No photo uploaded</em></p>
                                    @endif
                                </div>
                            </div>
                                    ...
                                    <div class="ctmr-box">
                                        ...
                                        <ul class="list-group">
                                            <li class="list-group-item border-0 ps-0 pt-0 text-sm">
                                                <strong class="text-dark">Type:</strong> &nbsp; RETAILER
                                            </li>
                                            ...
                                            <li class="list-group-item border-0 ps-0 text-sm">
                                                <strong class="text-dark">Distributor Name:</strong> &nbsp; {{ $customer->distributor_name ?? '-' }}
                                            </li>
                                ...
                                <div class="card-body p-3">
                                    <div class="ctmr-box">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <!-- <li class="list-group-item border-0 ps-0 text-sm">
                                                <strong class="text-dark">Sub Type:</strong> &nbsp;
                                                {{ $customer->sub_type ?? '-' }}
                                            </li> -->
                                            <li class="list-group-item border-0 ps-0 text-sm">
                                                <strong class="text-dark">Owner Name:</strong> &nbsp;
                                                {{ $customer->owner_name }}
                                            </li>
                                            <li class="list-group-item border-0 ps-0 text-sm">
                                            ...
                                            <li class="list-group-item border-0 ps-0 text-sm">
                                                <strong class="text-dark">Mobile Numbers:</strong>
                                                ...
                                                <div class="mt-2 ms-4">
                                                    ...
                                                    <div class="d-flex align-items-baseline mb-2">
                                                        ...
                                                        <span style="margin-left: 1.5rem; font-weight: 500;">
                                                            {{ $number }}
                                                        </span>
                                                    </div>
                                                    @empty
                                                    <div class="text-muted mt-1">No mobile number provided</div>
                                                    @endforelse
                                                    @else
                                            ...
                                            <!-- <li class="list-group-item border-0 ps-0 text-sm">
                                                <strong class="text-dark">WhatsApp / Alternate:</strong> &nbsp;
                                                {{ $customer->whatsapp_number ?? '-' }}
                                            </li> -->
                                            <!-- <li class="list-group-item border-0 ps-0 text-sm">
                                                <strong class="text-dark">Vehicle Segment:</strong> &nbsp;
                                                {{ $customer->vehicle_segment ?? '-' }}
                                            </li> -->
                                            <li class="list-group-item border-0 ps-0 text-sm">
    <strong class="text-dark">Distributor{{ str_contains($customer->distributor_name ?? '', ',') ? 's' : '' }}:</strong>
    <div class="mt-1 ms-4">
        @if($customer->distributor_name)
            @php
                $distIds = array_filter(array_map('trim', explode(',', $customer->distributor_name)));
                $distributors = \App\Models\MasterDistributor::whereIn('id', $distIds)
                    ->pluck('legal_name', 'id')   // key = id, value = name
                    ->all();
            @endphp

            @forelse($distIds as $index => $id)
                <div class="d-flex align-items-baseline mb-1">
                    <span class="text-muted me-3" style="min-width: 110px;">
                        Distributor {{ $index + 1 }}:
                    </span>
                    <span style="margin-left: 1.5rem;">
                        {{ $distributors[$id] ?? 'Unknown (ID: ' . $id . ')' }}
                    </span>
                </div>
            @empty
        ...
        @endif
                                            ...
                                            <!-- Opportunity Status (existing) -->
                                            <!-- <li class="list-group-item border-0 ps-0 pt-3 text-sm"> ... (your
                                                opportunity status) </li> -->

                                            <!-- Nistha Awareness -->
                                            <!-- <li class="list-group-item border-0 ps-0 text-sm">
                                                <strong class="text-dark">
                                                    <i class="material-icons"
                                                        style="font-size:18px;vertical-align:middle;">school</i>
                                                    Nistha Awareness Status:
                                                </strong>
                                                &nbsp;
                                                <span
                                                    class="badge badge-pill {{ $customer->nistha_awareness_status == 'Done' ? 'badge-success' : 'badge-danger' }}">
                                                    {{ $customer->nistha_awareness_status == 'Done' ? 'DONE' : 'NOT DONE' }}
                                                </span>
                                            </li> -->

                                            <!-- NEW: Saathi Awareness -->
                                            <!-- <li class="list-group-item border-0 ps-0 text-sm">
                                                <strong class="text-dark">
                                                    <i class="material-icons" style="font-size:18px;vertical-align:middle;">school</i>
                                            ...
                                            <li class="list-group-item border-0 ps-0 text-sm">
                                                ...
                                                <span
                                                    class="badge badge-pill {{ $customer->active ? 'badge-success' : 'badge-danger' }}">
                                            ...
                                            <li class="list-group-item border-0 ps-0 text-sm">
                                                ...
                                                {{ showdatetimeformat($customer->created_at) }}
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="card card-plain h-100">
                                <div class="card-body p-3">
                                    <div class="ctmr-box">
                                        ...
                                        $state = \App\Models\State::find($customer->state_id);
                                        $city = \App\Models\City::find($customer->city_id);
                                        $district = \App\Models\District::find($customer->district_id);
                                        $pincode = \App\Models\Pincode::find($customer->pincode_id);
                                        $beat = \App\Models\Beat::find($customer->beat_id);
                                        $country = \App\Models\Country::find($customer->country_id);
                                        @endphp

                                        <ul class="list-group">
                                            <li class="list-group-item border-0 ps-0 pt-0 text-sm">
                                                <strong class="text-dark">Address Line:</strong> &nbsp;
                                            ...
                                            <li class="list-group-item border-0 ps-0 text-sm">
                                                <strong class="text-dark">Beat:</strong> &nbsp;
                                                {{ $beat?->beat_name ?? $beat?->name ?? '-' }}
                                            </li>
                                            <li class="list-group-item border-0 ps-0 text-sm">
                                                <strong class="text-dark">Belt / Area / Market:</strong> &nbsp;
                                                {{ $customer->belt_area_market_name ?? '-' }}
                                            </li>
                                            <li class="list-group-item border-0 ps-0 text-sm">
                                                <strong class="text-dark">GPS Coordinates:</strong> &nbsp;
                                                @if($customer->gps_location)
                                                ...
                                                <small>
                                                    <a href="https://www.google.com/maps/search/?api=1&query={{ $customer->gps_location }}"
                                                        ...
                                                        <i class="material-icons"
                                                            style="font-size:14px;vertical-align:middle;">open_in_new</i>
                                                        Open in Google Maps
                                                    </a>
                                                </small>
                                                @else
                                        ...
                                        @if($customer->gps_location)
                                        <div class="mt-4 text-center">
                                            <button type="button" class="btn btn-theme btn-round shadow-sm"
                                                onclick="showRetailerOnMap()">
                                                <i class="material-icons">location_on</i>
                                                View Location on Map
                                            </button>
                            ...
                            <div class="card card-plain h-100">
                                <div class="card-body p-3">
                                    <div class="ctmr-box">
                                        ...
                                        <ul class="list-group">
                                            <li class="list-group-item border-0 ps-0 text-sm">
                                                <strong class="text-dark">Bank Account Type:</strong> &nbsp;
                                                {{ $customer->bank_account_type ?? '-' }}
                                            </li>
                                            <li class="list-group-item border-0 ps-0 text-sm">
                                                <strong class="text-dark">Bank Account Number:</strong> &nbsp;
                                            ...
                                            <li class="list-group-item border-0 ps-0 text-sm">
                                                <strong class="text-dark">Account Holder Name:</strong> &nbsp;
                                    ...
                                    <div class="ctmr-box">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item border-0 ps-0 text-sm">
                                                ...
                                                {{ $customer->gst_number ?? '-' }}
                                                @if($customer->gst_attachment)
                                                <br>
                                                <img src="{{ asset('storage/'.$customer->gst_attachment) }}"
                                                    class="img-fluid rounded shadow-sm retailer-image-popup cursor-pointer mt-2"
                                                    style="max-height: 180px; object-fit: cover;" alt="GST Attachment">
                                                @else
                                                <p class="text-muted mt-2 mb-0"><em>No GST attachment</em></p>
                                                @endif
                                            </li>

                                            <!-- PAN -->
                                            <li class="list-group-item border-0 ps-0 text-sm">
                                                <strong class="text-dark">PAN Number:</strong> &nbsp;
                                                {{ $customer->pan_number ?? '-' }}
                                                @if($customer->pan_attachment)
                                                <br>
                                                <img src="{{ asset('storage/'.$customer->pan_attachment) }}"
                                                    class="img-fluid rounded shadow-sm retailer-image-popup cursor-pointer mt-2"
                                                    style="max-height: 180px; object-fit: cover;" alt="PAN Attachment">
                                                @else
                                                <p class="text-muted mt-2 mb-0"><em>No PAN attachment</em></p>
                                                @endif
                                            </li>

                                            <!-- Bank Proof -->
                                            <li class="list-group-item border-0 ps-0 text-sm">
                                                <strong class="text-dark">Bank Proof:</strong>
                                                @if($customer->bank_proof)
                                                <br>
                                                <img src="{{ asset('storage/'.$customer->bank_proof) }}"
                                                    class="img-fluid rounded shadow-sm retailer-image-popup cursor-pointer mt-2"
                                                    style="max-height: 180px; object-fit: cover;" alt="Bank Proof">
                                                @else
                                                <p class="text-muted mt-2 mb-0"><em>No bank proof uploaded</em></p>
                                                @endif
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12">
                            <div class="showCustomerLocationonMaps" style="display:none;">
                                <div id="retailerMap" style="height: 600px; width: 100%; border-radius: 0.5rem;"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-right mt-5">
                        <a href="{{ route('retailers.edit', encrypt($customer->id)) }}"
                            class="btn btn-warning btn-lg mr-3 shadow-sm">
                            <i class="material-icons">edit</i> Edit Retailer
                        </a>
                        <a href="{{ route('retailers.index') }}" class="btn btn-secondary btn-lg shadow-sm">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Class for retailer images (different from workshop to avoid conflict)
        document.querySelectorAll('.retailer-image-popup').forEach(img => {
    ...
    // Map Function for Retailer
    function showRetailerOnMap() {
        ...
        const map = new google.maps.Map(document.getElementById('retailerMap'), {
            zoom: 16,
            center: {
                lat,
                lng
        ...
        document.querySelector('.showCustomerLocationonMaps').scrollIntoView({
            behavior: 'smooth'
        });
    }
    </script>
