<x-app-layout>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-icon card-header-theme">
                    ...
                    <h4 class="card-title">
                        {{ $typeTitle ?? 'Garages List' }}
                        <span class="float-right">
                            <button class="btn btn-info" type="button" data-toggle="collapse"
                                data-target="#advanceFilter">
                                <i class="material-icons">tune</i> Filter
                            </button>
                            <a href="{{ route('garages.create') }}" class="btn btn-theme">
                                <i class="material-icons">add_circle</i> Add New Garage
                            </a>
                        </span>
                    </h4>
                </div>
            ...
            @endif 
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="garagesTable" class="table table-striped table-bordered table-hover w-100">
    ...
    $(document).ready(function() {
        ...
        let table = $('#garagesTable').DataTable({
            processing: true,
            serverSide: true,
            searching: false,
            ordering: true,
            ...
            columns: [{
                ...
                {
                    data: 'saathi_awareness_status',
                    name: 'saathi_awareness_status',
                    orderable: false
                },
                {
                    data: 'created_at',
            ...
            language: {
                processing: "Loading garages...",
                zeroRecords: "No garages found",
                info: "Showing _START_ to _END_ of _TOTAL_ garages",
