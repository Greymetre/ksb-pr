<x-app-layout>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-icon card-header-theme">
                    ...
                    <h4 class="card-title">
                        ...
                        <span class="pull-right">
                            <a href="{{ route('garages.index') }}" class="btn btn-theme">
                ...
                <div class="card-body">
                    ...
                    <h5 class="mt-3 mb-4 text-theme font-weight-bold">Garage Photos</h5>
                    <div class="row mb-5">
                                ...
                                <div class="card-body p-3">
                                    @if($customer->owner_photo)
                                        <img src="{{ asset('storage/'.$customer->owner_photo) }}"
                                             class="img-fluid rounded shadow-sm garage-image-popup cursor-pointer"
                                    ...
                                    <div class="ctmr-box">
                                        ...
                                        <ul class="list-group">
                                            <li class="list-group-item border-0 ps-0 pt-0 text-sm">
                                                <strong class="text-dark">Type:</strong> &nbsp; GARAGE
                                            </li>
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12">
                            <div class="showCustomerLocationonMaps" style="display:none;">
                                <div id="garageMap" style="height: 600px; width: 100%; border-radius: 0.5rem;"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-right mt-5">
                        <a href="{{ route('garages.edit', encrypt($customer->id)) }}"
                           class="btn btn-warning btn-lg mr-3 shadow-sm">
                            <i class="material-icons">edit</i> Edit Garage
                        </a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Unique class for Garage images
            document.querySelectorAll('.garage-image-popup').forEach(img => {
        ...
        // Map Function for Garage
        function showGarageOnMap() {
            ...
            const map = new google.maps.Map(document.getElementById('garageMap'), {
                zoom: 16,
                center: { lat, lng },
                mapTypeId: 'hybrid',
