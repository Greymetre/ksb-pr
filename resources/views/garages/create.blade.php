    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-icon card-header-theme">
                ...
                <h4 class="card-title">
                    {{ isset($customer) && $customer->exists ? 'Edit' : 'Add New' }} Garage
                    <span class="pull-right">
                        <a href="{{ route('garages.index') }}" class="btn btn-just-icon btn-theme">
            ...
            <div class="card-body">
                ...
                {{-- CORRECT: Dynamic type from controller --}}
            ...
            'placeholder' => 'e.g., 17.385044,78.486671'
                ...
                <div class="card-footer text-right mt-5">
                    <button type="submit" class="btn btn-theme">
                        {{ isset($customer) && $customer->exists ? 'Update' : 'Save' }} Garage
                    </button>
                    <a href="{{ route('garages.index') }}" class="btn btn-secondary ml-2">Cancel</a>
                </div>
...
<script>
    $('.select2').select2();
    // Your address AJAX chaining script here (same as before)
</script>
</x-app-layout>