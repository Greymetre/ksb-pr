                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Appraisal View</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        @if($errors->any())
                                        ...
                                        <table class="table kvcodes-dynamic-rows-example" id="table_appraisal">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{explode(',',$appraisal_detail->targets)[0]??''}}
                                                    </td>
                                                    <td>
                                                       {{explode(',',$appraisal_detail->achivments)[0]??''}}
                                                    </td>
                                                    <td>
                                                        {{explode(',',$appraisal_detail->acuals)[0]??''}}
                                                    </td>
                                                    <td>10</td>
                                                  ...
                                                  <?php $i++; ?>                                                 
                                                   ...
                                                   <tr>
                                                       <td colspan="9"> Grade</td>
                                                       @foreach($appraisal_grade_details as $keys => $grade)
